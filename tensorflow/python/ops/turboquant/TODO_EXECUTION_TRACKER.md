...
- Benchmarks are strong on drift/compression/latency but do not yet enforce
  task-level quality guarantees.
...
- [ ] A4. Add runtime feature flag and safe fallback path
...
- [ ] B1. Define task-level eval protocol (beyond MSE/drift)
  - Output: fixed tasks, fixed seeds, fixed evaluation command lines.
- [ ] B2. Add evaluation hooks for task metrics in benchmark tooling
...
- [ ] B4. Document accepted quality/perf trade-off envelopes
...
- [ ] E5. Documentation updated (`README`, limitations, roadmap, reproducibility).
